...
export default function AnalyticsDashboardPage() {
  ...
  if (error || !data) {
    return (
      <div className="bg-background text-text-primary mx-auto flex min-h-screen w-full max-w-7xl flex-col items-center justify-center p-6 md:p-12">
        <AlertTriangle className="mb-4 h-12 w-12 text-rose-500" />
        <h3 className="text-lg font-bold">Analytics Load Error</h3>
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                ...
                <CardDescription className="text-text-muted text-xs">
                  Spread of average pays (highest vs. lowest country average)
                  within the same role + level
                </CardDescription>
              </div>
